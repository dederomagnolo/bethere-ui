...
import { Checkbox, CustomSelect, DeviceSelector } from 'components'
...
const getDefaultValues = ({ 
  ...
  alertToEdit: Alert,
  sensorOptions: SelectOptions[],
  paramOptions: SelectOptions[]
}) => {
...
export const Form = ({
  ...
  const deviceOptions = getDeviceOptionsToSelect(userDevices)
  ...
  const saveChanges = async () => {
    ...
    const updatedAlerts = await action({
      token,
      deviceId: selectedSensor.linkedWith,
      sensorId: selectedSensor._id,
      alertName,
      paramType,
      value,
